...
# Run QEMU
qemu-system-aarch64 -machine sbsa-ref -cpu max -m 4G -drive if=pflash,format=raw,file=$PLATFORM_ROOT/output/SBSA_FLASH0.fd -drive if=pflash,format=raw,file=$PLATFORM_ROOT/output/SBSA_FLASH1.fd -serial stdio